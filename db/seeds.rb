...
demouser3 = User.create!({first_name: 'Anna', last_name: 'Smith', location: 'San Francisco', age: 23, email: 'anna@gmail.com', password: 'annaanna'})
...
board4 = Board.create({author_id: demouser2.id, name: "Kim Kardashian"})
board5 = Board.create({author_id: demouser3.id, name: "Kimbap"})
