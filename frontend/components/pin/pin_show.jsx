  ...
  render(){
    ...
    return (
      ...
      <div className="pin-container">
          <div id='pin-image'><img src={this.props.pin.photo_url} /><button className="edit-pin-button" onClick={() => this.props.openModal('editPin', { id: this.props.pin.id })}>Edit</button></div>
          <div id="pin-info">
